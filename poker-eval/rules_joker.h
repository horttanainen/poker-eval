...
POKEREVAL_EXPORT const char *JokerRules_handTypeNames[JokerRules_HandType_LAST+1];
POKEREVAL_EXPORT const char *JokerRules_handTypeNamesPadded[JokerRules_HandType_LAST+1];

POKEREVAL_EXPORT int JokerRules_nSigCards[JokerRules_HandType_LAST+1];
